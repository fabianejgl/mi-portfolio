...
#define KERNEL_PAGE_TABLE_0 (0x00026000)      //SON ESOS NÚMEROS POR SER DE 20 BITS????
#define KERNEL_STACK (0x00025000)             //SE USAN PARA LA PARTE DE NEXT FREE KERNEL PAGE?
                                          //NO, PORQUE SON DEL KERNEL, NO ESTÁN EN LA PARTE LIBRE
/* GDT */
